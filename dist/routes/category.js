...
import { getCategory, getCategorybyId, postCategory, updateCategorybyId, postCategorybyId, deleteCategory, viewCategory } from '../controllers/category.controller.js';
import { isLoggedIn } from '../libs/logged.js';
import { verifyToken } from '../middlewares/authjwt.js';
const router = Router(); // GET categories / private
